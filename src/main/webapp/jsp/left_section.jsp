            ...
            <ol class="left__nav-container">
                <li class="left__nav-element">
                    <a href="${pageContext.request.contextPath}/main?command=show_profile&login=${user.login}" class="nav-element">
                        ...
                        <span class="left__nav-element-text"><fmt:message key="navbar.profile"/></span>
                    </a>
                </li>
                <li class="left__nav-element">
                    <a class="nav-element" href="${pageContext.request.contextPath}/main?command=show_news">
						<span class="left__nav-element-icon">
                        ...
                        <span class="left__nav-element-text"><fmt:message key="navbar.news"/></span>
                    </a>
                </li>
                <li class="left__nav-element">
                    <a class="nav-element" href="${pageContext.request.contextPath}/main?command=show_messenger">
						<span class="left__nav-element-icon">
							<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="left__nav-element-text"><fmt:message key="navbar.messenger"/></span>
                    </a>
                </li>
                <li class="left__nav-element">
                    <a class="nav-element" href="${pageContext.request.contextPath}/main?command=show_subscriptions&login=${user.login}">
                        ...
                        <span class="left__nav-element-text"><fmt:message key="navbar.subscriptions"/></span>
                    </a>
                </li>
                <li class="left__nav-element">
                    <a class="nav-element" href="${pageContext.request.contextPath}/main?command=show_subscribers&login=${user.login}">
                        ...
                        <span class="left__nav-element-text"><fmt:message key="navbar.subscribers"/></span>
                    </a>
                </li>
            </ol>
        </nav>
