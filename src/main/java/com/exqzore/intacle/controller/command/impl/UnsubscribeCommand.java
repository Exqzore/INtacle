...
import com.exqzore.intacle.service.SubscriberService;
import com.exqzore.intacle.service.impl.SubscriberServiceImpl;
...
public class UnsubscribeCommand implements Command {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            subscriberService.unsubscribe(user.getLogin(), subscriptionLogin);
